...
export const themes: Theme[] = [
  ...
  },
  {
    id: 'carbon',
    name: 'Carbon',
    description: 'Refined dark slate with electric blue',
    swatch: 'linear-gradient(135deg, #3b82f6, #818cf8)',
    vars: {
      bg: '#0c0c0f',
      bgCard: 'rgba(255,255,255,0.035)',
      bgCardHover: 'rgba(255,255,255,0.06)',
      bgGlass: 'rgba(12,12,15,0.75)',
      ...
      scoreMid: '#fbbf24',
      scoreLow: '#f87171',
      glowAccent: 'rgba(59,130,246,0.35)',
      glowHigh: 'rgba(52,211,153,0.45)',
      glowMid: 'rgba(251,191,36,0.35)',
      glowLow: 'rgba(248,113,113,0.35)',
      textPrimary: '#f1f5f9',
      textSecondary: '#94a3b8',
      textMuted: '#64748b',
      gradientFrom: '#3b82f6',
